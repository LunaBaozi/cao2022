...
if ( not avid_kd_llh is None ):
    ...
    avid_above_0 = (shifted_avid > 0).astype(int) 
    ...
    avid_ub_i = np.cumsum(avid_above_0, axis=-1).argmax(axis=-1)
    ...
    avid_kd_includes_this &= np.cumsum(avid_above_0, axis=-1).clip(0, 1).astype(bool)
...
if ( args.dump_round_information ):
